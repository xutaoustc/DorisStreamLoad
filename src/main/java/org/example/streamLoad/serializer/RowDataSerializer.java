...
import static org.example.streamLoad.LoadConstants.CSV;
import static org.example.streamLoad.LoadConstants.DORIS_DELETE_SIGN;
import static org.example.streamLoad.LoadConstants.JSON;
import static org.example.streamLoad.LoadConstants.NULL_VALUE;
...
public class RowDataSerializer implements DorisRecordSerializer<RowData> {
    ...
    private RowDataSerializer(String[] fieldNames, LogicalType[] dataTypes, String type, String fieldDelimiter, boolean enableDelete) {
    ...
    public static class Builder {
        ...
        public Builder setFieldType(LogicalType[] dataTypes) {
